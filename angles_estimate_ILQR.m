...
time = cord(:,1);
gtc = 56:77; % gait cycle time is from 0.23 to 1.58 seconds
tfit = time(gtc);
dt = 0.01; % dt should be set to 0.01 only
tt = 0.54:dt:0.75;


f1 = fit(tfit,theta_HAT(56:77)','fourier8');
tht1 = f1(tt);
f2 = fit(tfit,theta_l_thigh(56:77)','fourier8');
tht2 = f2(tt);
f3 = fit(tfit,theta_l_leg(56:77)','fourier8');
tht3 = f3(tt);
f4 = fit(tfit,theta_l_ankle(56:77)','fourier8');
tht4 = f4(tt);
f5 = fit(tfit,theta_r_thigh(56:77)','fourier8');
tht5 = f5(tt);
f6 = fit(tfit,theta_r_leg(56:77)','fourier8');
tht6 = f6(tt);
f7 = fit(tfit,theta_r_ankle(56:77)','fourier8');
tht7 = f7(tt);
